...
function createPackageGraph(packages, filters) {
    ...
    function getDependencyMapForFilter(packages, filter) {
        ...
        if (filter.withDevDependencies && filter.withPeerDependencies) {
            dependencyMapWithPeerDevDeps ?? (dependencyMapWithPeerDevDeps = (0, createDependencyMap_1.createDependencyMap)(packages, filter));
            return dependencyMapWithPeerDevDeps;
        }
        if (filter.withDevDependencies && !filter.withPeerDependencies) {
            dependencyMapWithDevDeps ?? (dependencyMapWithDevDeps = (0, createDependencyMap_1.createDependencyMap)(packages, filter));
            return dependencyMapWithDevDeps;
        }
        if (!filter.withDevDependencies && filter.withPeerDependencies) {
            dependencyMapWithPeerDeps ?? (dependencyMapWithPeerDeps = (0, createDependencyMap_1.createDependencyMap)(packages, filter));
            return dependencyMapWithPeerDeps;
        }
        dependencyMapWithoutPeerDevDeps ?? (dependencyMapWithoutPeerDevDeps = (0, createDependencyMap_1.createDependencyMap)(packages, filter));
