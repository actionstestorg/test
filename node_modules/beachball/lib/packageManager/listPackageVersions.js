...
async function getNpmPackageInfo(packageName, options) {
    ...
    if (env_1.env.beachballDisableCache || !packageVersionsCache[packageName]) {
        const showResult = await (0, npm_1.npm)(['show', '--registry', registry, '--json', packageName, ...(0, npmArgs_1.getNpmAuthArgs)(registry, token, authType)], { timeout, cwd: options.path });
